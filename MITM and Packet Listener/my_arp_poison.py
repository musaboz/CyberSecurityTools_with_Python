...
hwsrc      : MultipleTypeField (SourceMACField, StrFixedLenField) = '$MAC_ADDRESS' ('None')
psrc       : MultipleTypeField (SourceIPField, SourceIP6Field, StrFixedLenField) = '$IP_ADDRESS'      ('None')
